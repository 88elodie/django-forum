    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('upload_id', models.CharField(max_length=22, primary_key=True, serialize=False, validators=[django.core.validators.MinLengthValidator(22)])),
                ('file_id', models.CharField(max_length=22, validators=[django.core.validators.MinLengthValidator(22)])),
                ('file', models.FileField(storage=django_drf_filepond.models.FilePondUploadSystemStorage(), upload_to=django_drf_filepond.models.get_upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('upload_id', models.CharField(max_length=22, primary_key=True, serialize=False, validators=[django.core.validators.MinLengthValidator(22)])),
                ('file', models.FileField(max_length=2048, storage=django_drf_filepond.models.FilePondLocalStoredStorage(), upload_to='')),
